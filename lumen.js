...
var sch = {};
sch[43200000] = [-1,125,256];
console.log(sch);
function lmn(){
    var day = Date.now()%86400000;
    var color0 = Color().rgb(255, 0, 255);
    var color1 = Color().rgb(0, 255, 0);
    color0.hue(180);
    color1.hue(180);
    var colour0 = color0.hexString();
    var colour1 = color1.hexString();
    console.log(day);
    document.body.setAttribute("style","background-color: "+colour0+";color: "+colour1+";");
    console.log(colour0,colour1);
    setTimeout(lmn,100);
} 
